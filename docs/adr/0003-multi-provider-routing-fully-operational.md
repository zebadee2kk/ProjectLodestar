# ADR-0003: Multi-Provider Routing Fully Operational
...
### Positive
- Virtually unlimited free coding assistance
- Premium models available on demand
- No vendor lock-in

### Negative
- Requires maintaining Ollama server
- Local model quality lower for complex tasks
